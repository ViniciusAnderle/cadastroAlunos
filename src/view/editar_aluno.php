...
{
    private $alunos = [];
    //Função aonde cadastra os Alunos, certificando que está com os atributos corretos.
                        ...
                        <div class="row">
                            <div class="col">
                                <form method="post" action="registra_alunos.php">
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-6">
                                            <button class="btn btn-lg btn-info btn-block" style="width:500px" type="submit">Cadastrar</button>
                                        </div>
                                        <div class="col-6">

                                            <div class="col-6">

                                                <a class="btn btn-lg btn-warning btn-block" style="width: 500px;" href="home.php">Voltar</a>
                                            </div>
                                        </div>
